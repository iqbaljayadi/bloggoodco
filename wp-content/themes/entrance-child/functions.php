...
register_sidebars(
	2,
	array(
		'before_title'=>'<span class="homepage-custom-widget-title">',
		'after_title'=>'<i class="fa fa-angle-right"></i></span>',
		'name'=>'Homepage Widget %d',
		'id'=>'homepage-sidebar',
		'class'=>'col-sm-6',
...
add_action( 'after_setup_theme', 'tonjoo_home_thumbnail' );
function tonjoo_home_thumbnail() {
	add_image_size( 'tonjoo-default-thumb', 240, 200, true );
	add_image_size( 'tonjoo-wide-thumb', 510, 200, true );
}