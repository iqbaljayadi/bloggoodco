...
---------------------------------------------------------- */
    public function getColumnControls($controls, $extended_css = '') {
        ...
        $controls_add = ' <a class="column_add controls-type-'.$controls.'" href="#" title="'.__('Add to ', 'js_composer').$this->settings('name').'"></a>';

        $controls_edit = ' <a class="column_edit controls-type-'.$controls.'" href="#" title="'.__('Edit ', 'js_composer').$this->settings('name').'"></a>';
        $controls_popup = ' <a class="column_popup controls-type-'.$controls.'" href="#" title="'.__('Pop up ', 'js_composer').$this->settings('name').'"></a>';
        $controls_delete = ' <a class="column_clone controls-type-'.$controls.'" href="#" title="'.__('Clone ', 'js_composer').$this->settings('name').'"></a> <a class="column_delete" href="#" title="'.__('Delete' , 'js_composer').$this->settings('name').'"></a>';
...
abstract class WPBakeryShortCode_UniversalAdmin extends WPBakeryShortCode {
    ...
    public function contentAdmin($atts,  $content) {
        ...
        if ( isset($this->settings['params']) ) {
            ...
            $output .= '<div class="span12 wpb_edit_form_elements"><h2>'.__('Edit', 'js_composer').' ' .$this->settings['name'].'</h2>';
    ...
    protected function singleParamEditHolder($param, $param_value) {
        ...
        $output .= '<div class="wpb_element_label">'.$param['heading'].'</div>';//span3
