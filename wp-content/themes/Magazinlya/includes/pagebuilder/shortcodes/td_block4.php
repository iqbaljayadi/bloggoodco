...
function td_block4_inner(&$td_query, $td_column_number = '') { //$td_query by ref
    global $post;
...
function td_block4($atts) {
    ...
    $buffy .= td_block_builder::get_block_js($atts, $td_unique_id, $td_query, 4);
    ...
    $buffy .= '<div class="td_block_wrap td_block4">';
        ...
        $buffy .= '<div id=' . $td_unique_id . ' class="td_block_inner">';
            ...
            $buffy .= td_block4_inner($td_query);
        $buffy .= '</div>';
...
add_shortcode('td_block4', 'td_block4');
