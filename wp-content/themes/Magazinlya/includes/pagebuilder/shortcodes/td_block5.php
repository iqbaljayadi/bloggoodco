...
function td_block5_inner(&$td_query, $td_column_number = '') { //$td_query by ref
    global $post;
        ...
        while ($td_query->have_posts()) : $td_query->the_post();
            switch ($td_column_number) {
                ...
                case '1': //one column layout
                    $buffy .= td_modules::mod4_render($post);
                    break;
...
function td_block5($atts) {
    ...
    $buffy .= td_block_builder::get_block_js($atts, $td_unique_id, $td_query, 5);
    ...
    $buffy .= '<div class="td_block_wrap td_block5">';
        ...
        $buffy .= '<div id=' . $td_unique_id . ' class="td_block_inner">';
            ...
            $buffy .= td_block5_inner($td_query);
        $buffy .= '</div>';
...
add_shortcode('td_block5', 'td_block5');
