...
function td_block2_inner(&$td_query, $td_column_number = '') { //$td_query by ref
    global $post;
            ...
            switch ($td_column_number) {
                ...
                case '1': //one column layout
                    if ($td_post_count == 0) { //first post
                        $buffy .= td_modules::mod5_render($post);
                    } else {
...
function td_block2($atts) {
    ...
    $buffy .= td_block_builder::get_block_js($atts, $td_unique_id, $td_query, 2);
    ...
    $buffy .= '<div class="td_block_wrap td_block2">';
        ...
        $buffy .= '<div id=' . $td_unique_id . ' class="td_block_inner">';
            ...
            $buffy .= td_block2_inner($td_query);
        $buffy .= '</div>';
...
add_shortcode('td_block2', 'td_block2');
