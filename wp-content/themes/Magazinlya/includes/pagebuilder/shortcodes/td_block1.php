...
function td_block1_inner(&$td_query, $td_column_number = '') { //$td_query by ref
    global $post;
            ...
            switch ($td_column_number) {
                ...
                case '1': //one column layout
                    if ($td_post_count == 0) { //first post
                        $buffy .= td_modules::mod2_render($post);
                    } else {
                        $buffy .= td_modules::mod3_render($post);
                    }
                    break;
...
function td_block1($atts) {
    ...
    $buffy .= td_block_builder::get_block_js($atts, $td_unique_id, $td_query, 1);
    ...
    $buffy .= '<div class="td_block_wrap td_block1">';
        ...
        $buffy .= '<div id=' . $td_unique_id . ' class="td_block_inner">';
            ...
            $buffy .= td_block1_inner($td_query);
        $buffy .= '</div>';
...
add_shortcode('td_block1', 'td_block1');
...
//print_r(td_get_category2id_array());
