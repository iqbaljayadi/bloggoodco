...
<div class="article__title__meta">
	...
	<time class="article__time" <?php echo $is_review ? 'itemprop="dtreviewed"' : ''; ?> datetime="<?php the_time('c'); ?>"> <?php printf(__('on %s', wpgrade::textdomain()),get_the_time(__('F j, Y', wpgrade::textdomain()))); ?></time>
</div>
