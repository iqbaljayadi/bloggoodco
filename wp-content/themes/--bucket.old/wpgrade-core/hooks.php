...
function wpgrade_callback_themesetup() {
	...
	//add_action('wp_head', 'wpgrade_callback_load_custom_js',999); // Commented by Ken Reidy
	//add_action('wp_footer', 'wpgrade_callback_load_custom_js_footer',999); // Commented by Ken Reidy
	...
	if ( wpgrade::option('inject_custom_css') == 'inline' ) {
		...
		//add_action('wp_enqueue_scripts', $handler,999999); // Commented by Ken Reidy
	}
