...
$meta_boxes['pagebuilder_metabox'] = array(
	...
	'pages'     => array('page'),
	'templates' => array('page-builder.php', 'page-builder-2.php'),
	'context'   => 'normal',
	'priority'  => 'high',
	'fields'    => array(
		'cat' => array(
...
$meta_boxes['sitemap_metabox'] = array(
	'title'     => __('Sitemap Options', 'g7theme'),
	'pages'     => array('page'),
	...
	'fields'    => array(
		'sitemap_pages' => array(
			'type'    => 'checkbox',
			'name'    => __('Show Pages', 'g7theme'),
			'default' => 1,
		),
		'sitemap_pages_title' => array(
			'type'    => 'text',
			'name'    => __('Pages Title', 'g7theme'),
			'default' => 'Pages',
		),
		'sitemap_categories' => array(
			'type'    => 'checkbox',
			'name'    => __('Show Categories', 'g7theme'),
			'default' => 1,
		),
		'sitemap_categories_title' => array(
			'type'    => 'text',
			'name'    => __('Categories Title', 'g7theme'),
			'default' => 'Categories',
		),
		'sitemap_month' => array(
			'type'    => 'checkbox',
			'name'    => __('Show Monthly Archives', 'g7theme'),
			'default' => 1,
		),
		'sitemap_month_title' => array(
			'type'    => 'text',
			'name'    => __('Monthly Archives Title', 'g7theme'),
			'default' => 'Archives by Month',
		),
		'sitemap_posts' => array(
			'type'    => 'checkbox',
			'name'    => __('Show Latest Posts', 'g7theme'),
			'default' => 1,
		),
		'sitemap_posts_title' => array(
			'type'    => 'text',
			'name'    => __('Latest Posts Title', 'g7theme'),
			'default' => 'Latest Posts',
		),
		'sitemap_posts_num' => array(
			'type'    => 'text',
			'name'    => __('Number of Latest Posts', 'g7theme'),
			'size'    => 3,
			'default' => 20,
		),
	)
