...
define( 'NOTIFIER_XML_FILE', 'http://demo.gawibowo.com/' . G7_FOLDERNAME . '/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
