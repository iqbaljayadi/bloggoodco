...
class IPT_FSQM_Form_Elements_Base {
	...
	public function set_valid_elements() {
		...
		$elements['design']['elements'] = array(
			...
			'container' => array(
				'title' => __( 'Content Box', 'ipt_fsqm' ),
				'description' => __( 'Custom content box. Can contain other elements inside it.', 'ipt_fsqm' ),
				'droppable' => true,
			),
			'iconbox' => array(
	...
	public function get_available_webfonts() {
		$web_fonts = array(
			...
			'roboto' => array(
				...
				'include' => 'Roboto:400,700,400italic,700italic',
			),
			'quando' => array(
