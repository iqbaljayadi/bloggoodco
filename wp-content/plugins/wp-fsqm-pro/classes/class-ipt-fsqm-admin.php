...
class IPT_FSQM_Dashboard extends IPT_FSQM_Admin_Base {
	...
	public function index() {
		$this->index_head( __( 'WP Feedback, Survey & Quiz Manager Pro <span class="icon-arrow-right-2"></span> Dashboard', 'ipt_fsqm' ), false );
?>
...
<div class="ipt_uif_left_col"><div class="ipt_uif_col_inner">
	<?php $this->ui->iconbox( __( 'Latest Submission Statistics', 'ipt_fsqm' ), array( $this, 'meta_stat' ), 'bars' ); ?>
</div></div>
...
<div class="clear"></div>
<?php $this->ui->iconbox( __( 'Latest 10 Submissions', 'ipt_fsqm' ), array( $this, 'meta_ten' ), 'list-2' ); ?>
<div class="clear"></div>
<div class="ipt_uif_left_col"><div class="ipt_uif_col_inner">
...
<div class="clear"></div>
<?php $this->ui->iconbox( __( 'Generate Embed Code', 'ipt_fsqm' ), array( $this, 'meta_embed_generator' ), 'embed' ); ?>
<div class="clear"></div>
		<?php
...
<ul class="ipt_uif_ul_menu">
	<li><a class="icon-play" href="http://ipanelthemes.com/fsqm-doc/#!/gettingstarted"><?php _e( 'Getting Started', 'ipt_fsqm' ) ?></a></li>
	<li><a class="icon-file-3" href="http://ipanelthemes.com/fsqm-doc/"><?php _e( 'Documentation', 'ipt_fsqm' ); ?></a></li>
	<li><a class="icon-support" href="http://support.ipanelthemes.com/viewforum.php?f=5"><?php _e( 'Get Support', 'ipt_fsqm' ); ?></a></li>
</ul>
...
<ul class="ipt_uif_ul_menu">
	<li><a class="icon-twitter-2" href="http://twitter.com/iPanelThemes">@iPanelThemes</a></li>
	<li><a class="icon-facebook-2" href="https://www.facebook.com/iPanelThemes">/iPanelThemes</a></li>
	<li><a class="icon-google-plus-3" href="http://plus.google.com/111068628455450253377">+iPanelThemes</a></li>
</ul>
...
class IPT_FSQM_All_Forms extends IPT_FSQM_Admin_Base {
	...
	public function index() {
		if ( isset( $_GET['form_id'] ) ) {
			$this->index_head( __( 'WP Feedback, Survey & Quiz Manager Pro <span class="icon-arrow-right-2"></span> Update Form <a href="admin.php?page=ipt_fsqm_all_forms" class="add-new-h2">Go Back</a>', 'ipt_fsqm' ) );
			...
			$this->index_head( __( 'WP Feedback, Survey & Quiz Manager Pro <span class="icon-arrow-right-2"></span> View all forms', 'ipt_fsqm' ) . '<a href="admin.php?page=ipt_fsqm_new_form" class="add-new-h2">' . __( 'Add New', 'ipt_fsqm' ) . '</a>', false );
			$this->table_view->prepare_items();
?>
<div class="ipt_uif_iconbox ipt_uif_shadow glowy">
	<div class="ipt_uif_box cyan">
		<h3><span class="icon-pencil"></span><?php _e( 'Modify and/or View Forms', 'ipt_fsqm' ); ?></h3>
	</div>
...
class IPT_FSQM_New_Form extends IPT_FSQM_Admin_Base {
	...
	public function index() {
		$this->index_head( __( 'WP Feedback, Survey & Quiz Manager - Pro <span class="icon-arrow-right-2"></span> New Form', 'ipt_fsqm' ) );
		$this->form_element_admin->show_form();
		$this->index_foot( false );
	}
...
class IPT_FSQM_Report extends IPT_FSQM_Admin_Base {
	...
	public function index() {
		$this->index_head( __( 'WP Feedback, Survey & Quiz Manager - Pro <span class="icon-arrow-right-2"></span> Report &amp; Analysis', 'ipt_fsqm' ), false );
...
class IPT_FSQM_View_Submission extends IPT_FSQM_Admin_Base {
	...
	public function index() {
		...
		$this->index_head( __( 'WP Feedback, Survey & Quiz Manager - Pro <span class="icon-arrow-right-2"></span> View a Submission', 'ipt_fsqm' ), false, $ui_state );
		if ( isset( $_GET['id'] ) || isset( $_GET['id2'] ) ) {
...
<div class="ipt_uif_iconbox ipt_uif_shadow glowy">
	<div class="ipt_uif_box cyan">
		<h3><span class="icon-menu"></span><?php _e( 'Select a Submission', 'ipt_fsqm' ); ?></h3>
	</div>
	<div class="ipt_uif_iconbox_inner">
...
class IPT_FSQM_View_All_Submissions extends IPT_FSQM_Admin_Base {
	...
	public function index() {
		$this->index_head( __( 'WP Feedback, Survey & Quiz Manager - Pro <span class="icon-arrow-right-2"></span> View All Submissions', 'ipt_fsqm' ), false );
		$this->table_view->prepare_items();
?>
<style type="text/css">
	.column-star {
...
<div class="ipt_uif_iconbox ipt_uif_shadow glowy">
	<div class="ipt_uif_box cyan">
		<h3><span class="icon-pencil"></span><?php _e( 'Modify and/or View Submissions', 'ipt_fsqm' ); ?></h3>
	</div>
	<div class="ipt_uif_iconbox_inner">
		<form action="" method="get">
			<?php foreach ( $_GET as $k => $v ) : if ( $k == 'order' || $k == 'orderby' || $k == 'page' ) : ?>
...
class IPT_FSQM_Settings extends IPT_FSQM_Admin_Base {
	...
	public function index() {
		...
		$this->index_head( __( 'WP Feedback, Survey & Quiz Manager - Pro <span class="icon-arrow-right-2"></span> Settings', 'ipt_fsqm' ) );
?>
<div class="ipt_uif_iconbox ipt_uif_shadow glowy">
	<div class="ipt_uif_box cyan">
		<h3><span class="icon-cog"></span><?php _e( 'Modify Plugin Settings', 'ipt_fsqm' ); ?></h3>
	</div>
	<div class="ipt_uif_iconbox_inner">
		<table class="form-table">
			<tr>
...
<div class="ipt_uif_iconbox ipt_uif_shadow glowy">
	<div class="ipt_uif_box cyan">
		<h3><span class="icon-file-2"></span><?php _e( 'Modify Standalone Forms Settings', 'ipt_fsqm' ); ?></h3>
	</div>
	<div class="ipt_uif_iconbox_inner">
		<table class="form-table">
			<tbody>
...
class IPT_FSQM_Import_Export extends IPT_FSQM_Admin_Base {
	...
	public function index() {
		$this->index_head( __( 'WP Feedback, Survey & Quiz Manager Pro <span class="icon-arrow-right-2"></span> Import/Export Forms', 'ipt_fsqm' ), false );
...
<div class="wrap ipt_uif_common <?php echo $ui_class; ?>" id="<?php echo $this->pagehook; ?>_widgets">
	<div class="icon32">
		<span class="icon-<?php echo $this->icon; ?>"></span>
	</div>
...
class IPT_FSQM_Form_Table extends WP_List_Table {
	...
	public function prepare_items() {
		...
		$orderby = !empty( $_GET['orderby'] ) ? $wpdb->escape( $_GET['orderby'] ) : 'f.id';
