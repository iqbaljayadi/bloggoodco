...
<?php $this->ui->ajax_loader( true, 'ipt_fsqm_ajax_loader', array(
	...
	public function ajax_save() {
		if ( !wp_verify_nonce( $_REQUEST['ipt_fsqm_form_save_ajax'], 'ipt_fsqm_form_save_ajax' ) || ! current_user_can( 'manage_feedback' ) ) {
			echo 'cheating';
			die();
		}
...
?>
	...
	<div class="ipt_uif_column_medium ipt_uif_float_left">
		<!-- WP Editor -->
		<?php $this->ui->builder_wp_editor( 'ipt_fsqm_form_richtext' ); ?>
		<!-- End WP Editor -->
	...
	public function builder_sortable( $layout_element, $layout_key ) {
		...
		$element_definition['sub_title'] = $element['title'];
...
<table class="widefat">
	...
	<tbody>
		...
		<tr>
			...
			<td><span data-icon="&#x<?php echo dechex( $i_key ); ?>;" style="font-size: 32px; margin: 5px 0; display: inline-block; color: #333;"></span></td>
...
?>
	<table class="form-table">
		...
		<tbody>
			...
			<tr>
				<td colspan="3">
					<?php $this->ui->collapsible( __( 'Customize Validation', 'ipt_fsqm' ), array( array( $this, 'build_validation' ), array( $name_prefix, $element_structure['validation'], $data['validation'] ) ) ); ?>
				</td>
			</tr>
		</tbody>
	</table>
...
?>
	 ...
	 *========================================================================*/
	protected function build_col() {
		$this->ui->msg_okay( __( 'Please expand the column by clicking the <span class="icon-arrow-down"></span> Expand Icon and drop more elements inside.', 'ipt_fsqm' ) );
	}
