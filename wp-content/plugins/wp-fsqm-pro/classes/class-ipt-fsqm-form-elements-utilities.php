...
class IPT_FSQM_Form_Elements_Utilities extends IPT_FSQM_Form_Elements_Base {
	...
	public function enqueue() {
		$path =  plugins_url( '/lib/images/iconmoon/', IPT_FSQM_Loader::$abs_file );
		...
		wp_localize_script( 'ipt-fsqm-report', 'iptFSQMReport', apply_filters( 'ipt_fsqm_report_js', array(
			...
			'rating_img_full'  => '<img height="16" width="16" alt="1" src="' . $path . 'star3.png" />',
			'rating_img_half'  => '<img height="16" width="16" alt="0.5" src="' . $path . 'star2.png" />',
			'rating_img_empty' => '<img height="16" width="16" alt="0" src="' . $path . 'star.png" />',
...
<div class="ipt_fsqm_report_survey_<?php echo $mcq; ?> ipt_fsqm_report_container" style="display: none;">
	<?php $this->ui->iconbox_head( $this->mcq[$mcq]['title'], 'pie' ); ?>
				...
				<table class="ipt_fsqm_preview">
					...
					<tfoot>
						<tr>
							...
							<th style="width: 40%"><?php _e( 'Average', 'ipt_fsqm' ); ?><?php if ( $mcq['type'] == 'range' ) echo ' ' . __( 'difference', 'ipt_fsqm' ); ?></th>
						</tr>
					</tfoot>
					<tbody>
...
<div class="ipt_fsqm_report_feedback_<?php echo $freetype; ?> ipt_fsqm_report_container" style="display: none;">
	<?php $this->ui->iconbox_head( $this->freetype[$freetype]['title'], 'bubbles-2' ); ?>
