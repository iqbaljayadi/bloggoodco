...
<div class="ipt_uif_upload">
	<a target="_blank" href="<?php echo esc_attr( $value ); ?>" class="icon-download"></a>
...
<label for="<?php echo $id; ?>">
	...
	public function icon_selector( $name, $checked, $no = 'Do not show' ) {
		$icons = $this->get_valid_icons();
		$this->clear();
?>
<span class="ipt_uif_icon_selector_preview" data-icon="<?php echo $checked === 'none' ? '' : '&#x' . (string) dechex( $checked ) . ';'; ?>"></span>
<select class="ipt_uif_select ipt_uif_icon_selector" name="<?php echo $name; ?>" id="<?php echo $this->generate_id_from_name( $name ); ?>">
	<option value="none"<?php if ( $checked === 'none' ) echo ' selected="selected"'; ?> data-hex=""><?php echo $no; ?></option>
	<?php foreach ( $icons as $icon ) : ?>
	<optgroup label="<?php echo $icon['label']; ?>">
		<?php foreach ( $icon['elements'] as $i_key => $i_label ) : ?>
		<option value="<?php echo $i_key; ?>" data-hex="&#x<?php echo (string) dechex( $i_key ); ?>;"<?php if ( $checked !== 'none' && $checked == $i_key ) echo ' selected="selected"'; ?>><?php echo $i_label; ?></option>
		<?php endforeach; ?>
	</optgroup>
	<?php endforeach; ?>
</select>
...
<div class="ipt_uif_shadow glowy ipt_uif_collapsible" data-opened="<?php echo $open; ?>">
	<div class="ipt_uif_box cyan">
		<h3><a href="javascript:;"><span class="icon-file-3 heading_icon"></span><span class="icon-arrow-down-2 collapsible_state"></span><?php echo $label; ?></a></h3>
	</div>
...
?>
	 ...
	 * @return type
	 */
	public function iconbox( $label, $callback, $icon = 'info-2', $scroll = 0, $id = '', $classes = array() ) {
...
<div class="ipt_uif_iconbox ipt_uif_shadow glowy">
	<div class="ipt_uif_box cyan">
		<h3><span class="icon-<?php echo esc_attr( $icon ); ?>"></span><?php echo $label; ?></h3>
	</div>
...
<div class="ipt_uif_iconbox ipt_uif_shadow glowy">
	<div class="ipt_uif_box cyan ipt_uif_container_head">
		<?php echo $after; ?><h3><span class="icon-<?php echo esc_attr( $icon ); ?>"></span><?php echo $label; ?></h3>
	</div>
...
<script type="text/html" class="ipt_uif_builder_tab_li">
	...
	<li class="ipt_uif_builder_layout_tabs">
		<a href=""><span class="icon-insert-template ipt_uif_builder_tab_droppable"></span><span class="icon-expand ipt_uif_builder_tab_sort">&nbsp;</span></a>
...
<script type="text/html" class="ipt_uif_builder_tab_content">
	...
	public function builder_wp_editor( $id ) {
		echo '<div class="ipt_uif_builder_wp_editor ipt_uif_box white">';
		wp_editor( '', $id, array( 'editor_class' => 'ipt_uif_builder_wp_editor' ) );
		echo '</div>';
	}
...
?>
	...
	<?php endif; ?>
	<div class="ipt_uif_droppable_element_wrap">
		<a title="<?php echo $this->default_messages['droppable_messages']['drag']; ?>" class="icon icon-expand-2 ipt_uif_builder_sort_handle ipt_uif_builder_action_handle" href="javascript:;"></a>
		<a title="<?php echo $this->default_messages['droppable_messages']['settings']; ?>" class="icon-cog ipt_uif_builder_settings_handle ipt_uif_builder_action_handle" href="javascript:;"></a>
		<a title="<?php echo $this->default_messages['droppable_messages']['copy']; ?>" class="icon icon-paste-2 ipt_uif_builder_action_handle ipt_uif_builder_copy_handle" href="javascript:;"></a>
		<?php if ( isset( $element['droppable'] ) && $element['droppable'] == true ) : ?>
		<a title="<?php echo $this->default_messages['droppable_messages']['expand']; ?>" class="icon-arrow-down-2 ipt_uif_builder_droppable_handle ipt_uif_builder_action_handle" href="javascript:;"></a>
		<?php endif; ?>
...
<div class="ipt_uif_builder_layout <?php echo $type; ?>" id="<?php echo esc_attr( $id ); ?>" data-empty="<?php echo $empty_msg; ?>">
	<ul class="ipt_uif_builder_layout_tab">
		...
		<li class="ipt_uif_builder_layout_tabs">
			<a href="#<?php echo esc_attr( $id . '_' . $l_key ); ?>"><span class="icon-insert-template ipt_uif_builder_tab_droppable"></span><span class="icon-expand ipt_uif_builder_tab_sort">&nbsp;</span></a>
			<input type="hidden" class="ipt_uif_builder_helper tab_position" name="containers[]" value="<?php echo $l_key; ?>" />
		</li>
...
<div class="ipt_uif_builder_layout_settings_toolbar">
	<ul>
		...
		<li><a title="<?php echo $toolbar_copy; ?>" class="icon-paste-2 ipt_uif_builder_layout_copy" href="javascript:;"></a></li>
		<li><a title="<?php echo $toolbar_settings; ?>" class="icon-cog ipt_uif_builder_layout_settings" href="javascript:;"></a></li>
		<li><a title="<?php echo $toolbar_deleter; ?>" class="icon-cancel-circle ipt_uif_builder_layout_del" data-title="<?php echo esc_attr( $deleter_title ); ?>" data-msg="<?php echo esc_attr( $deleter_msg ); ?>" href="javascript:;"></a></li>
	</ul>
</div>
