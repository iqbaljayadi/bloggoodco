<?php 
	...
	function wpep_add_custom_meta_box() {
	    add_meta_box(
			'wpep_custom_meta_box', // $id
			'popup options', // $title 
			'wpep_show_custom_meta_box', // $callback
			'popup', // $page
			'normal', // $context
			'high'); // $pirority
	}
	add_action('add_meta_boxes', 'wpep_add_custom_meta_box');

	// Field Array
	$prefix = 'wpep_';

	$wpep_custom_meta_fields = array(
		array(
			'label'	=> 'Type',
			'desc'	=> '',
			'id'	=> $prefix.'type',
...
add_action('admin_head','wpep_add_custom_scripts');
function wpep_add_custom_scripts() {
	global $wpep_custom_meta_fields, $post;
	...
	foreach ($wpep_custom_meta_fields as $field) { // loop through the fields looking for certain types
...
// The Callback
function wpep_show_custom_meta_box() {
	global $wpep_custom_meta_fields, $post;
	...
	foreach ($wpep_custom_meta_fields as $field) {
...
// Save the Data
function wpep_save_custom_meta($post_id) {
    global $wpep_custom_meta_fields;
...
add_action('save_post', 'wpep_save_custom_meta');
?>