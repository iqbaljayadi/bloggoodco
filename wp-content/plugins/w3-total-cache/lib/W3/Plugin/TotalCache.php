        ...
        if (current_user_can('manage_options')) {
            ...
            if ($modules->is_enabled('pgcache') && w3_detect_post_id() && (!defined('DOING_AJAX') || !DOING_AJAX)) {
                $menu_items[] = array(
                    ...
                    'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_dashboard&amp;w3tc_flush_pgcache_purge_post&amp;post_id=' . w3_detect_post_id()), 'w3tc')
                );
            }
            ...
            if ($can_empty_file && ($can_empty_opcode || $can_empty_memcache)) {
                $menu_items[] = array(
                    ...
                    'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_dashboard&amp;w3tc_flush_file'), 'w3tc')
                );
            }
            ...
            if ($can_empty_opcode && ($can_empty_file || $can_empty_memcache)) {
                $menu_items[] = array(
                    ...
                    'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_dashboard&amp;w3tc_flush_opcode'), 'w3tc')
                );
            }
            ...
            if ($can_empty_memcache && ($can_empty_file || $can_empty_opcode)) {
                $menu_items[] = array(
                    ...
                    'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_dashboard&amp;w3tc_flush_memcached'), 'w3tc')
                );
            }
            ...
            if ($modules->is_enabled('browsercache') && $browsercache_update_media_qs) {
                $menu_items[] = array(
                    ...
                    'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_dashboard&amp;w3tc_flush_browser_cache'), 'w3tc')
                );
            }
            ...
            if ($modules->plugin_is_enabled()) {
                $menu_items[] = array(
                    ...
                    'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_dashboard&amp;w3tc_flush_all'), 'w3tc')
                );
            ...
            if ($modules->is_enabled('pgcache')) {
                $menu_items[] = array(
                    ...
                    'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_dashboard&amp;w3tc_flush_pgcache'), 'w3tc')
                );
            }
            ...
            if ($modules->is_enabled('minify')) {
                $menu_items[] = array(
                    ...
                    'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_dashboard&amp;w3tc_flush_minify'), 'w3tc')
                );
            }
            ...
            if ($modules->is_enabled('dbcache')) {
                $menu_items[] = array(
                    ...
                    'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_dashboard&amp;w3tc_flush_dbcache'), 'w3tc')
                );
            }
            ...
            if ($modules->is_enabled('objectcache')) {
                $menu_items[] = array(
                    ...
                    'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_dashboard&amp;w3tc_flush_objectcache'), 'w3tc')
                );
            }
            ...
            if (w3_is_pro($this->_config) || w3_is_enterprise($this->_config)) {
                if ($modules->is_enabled('fragmentcache')) {
                    $menu_items[] = array(
                        ...
                        'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_dashboard&amp;w3tc_flush_fragmentcache'), 'w3tc')
                    );
                }
            }
            ...
            if ($modules->is_enabled('varnish')) {
                $menu_items[] = array(
                    ...
                    'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_dashboard&amp;w3tc_flush_varnish'), 'w3tc')
                );
            }
            ...
            if ($modules->is_enabled('cdn')) {
                ...
                if (w3_cdn_can_purge_all($cdn_engine)) {
                    $menu_items[] = array(
                        ...
                        'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_cdn&amp;w3tc_flush_cdn'), 'w3tc')
                    );
                }
                if (!$cdn_mirror) {
                    $menu_items[] = array(
                        ...
                        'href' => wp_nonce_url(network_admin_url('admin.php?page=w3tc_cdn&amp;w3tc_cdn_queue'), 'w3tc'),
                        'meta' => array('onclick' => "w3tc_popupadmin_bar(this.href); return false")
                    );
                }
            }
