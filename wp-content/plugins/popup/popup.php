	...
	if(get_option('PPOPOUPUP_SESSION') == "YES")
	{
		...
		if ( isset($_SESSION['popupsession']) <> "YES" )
		{
			...
			$PPOPOUPUP_txt = $PPOPOUPUP_txt . '<div id="PopupDiv">';
				$PPOPOUPUP_txt = $PPOPOUPUP_txt . '<div class="PopupDivBar"><a href="#" onClick="PopupDivStop()" class="close">&nbsp;</a></div>';
				$PPOPOUPUP_txt = $PPOPOUPUP_txt . '<div class="PopupDivAds">'.$txt.'</div><iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fthegoodco&amp;width=360&amp;layout=standard&amp;action=like&amp;show_faces=true&amp;share=false&amp;height=80&amp;appId=159960010880487" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:320px; height:80px;" allowTransparency="true"></iframe>';
