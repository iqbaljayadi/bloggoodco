    ...
    function widget($args, $instance){
      ...
      <?php
        foreach($most_viewed_posts as $k => $post){
          ...
          ?>
          <li class="popular_posts_bars_li popular_posts_bars_color_<?php echo $class; if($instance['thumbnail']){ echo " with_thumbnail"; } ?>"><span class="popular_posts_bars_comment_count_hold"><a href="<?php echo get_permalink($post->id); ?>" class="popular_posts_bars_comment_count"><?php echo number_format($post->view_count); ?> <?php echo _n('view', 'views', $post->view_count, 'popularpostsbars') ?></a><span class="popular_posts_bars_comment_count_triangle"></span></span><a href="<?php echo get_permalink($post->id); ?>" class="popular_posts_bars_link"><?php echo $thumbnail  . get_the_title($post->id); ?></a></li>
          <?php
        }
        ?>
        </ul>
