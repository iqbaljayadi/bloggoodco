			...
			this.construct = function(arg1, arg2) {
				...
				return this.each(function(child) {
					...
					if (argvalue != null && this.bar != null && this.config != null) {
						...
						$.each( config.barImage , function(i , barImage){

							if( preloadedImages[ barImage ] == undefined ){

								preloadedImages[ barImage ] = new Image();

								preloadedImages[ barImage ].src = barImage;
						...
						$bar.css("background", 'url(' + config.image + ') '+((config.width * -1)) + 'px 50%');
						$bar.css("padding", "0");
						$bar.css("margin", "0");
						$this.append($bar);
						$this.append($text);
