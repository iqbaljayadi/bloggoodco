...
#listfusion-sidebar-three .af-header {
	background-image: url("<?php echo $item_display_options['field_img_url']; ?>");
}
#listfusion-sidebar-three .af-body input[type="submit"].listfusion-submit-btn {
...
#listfusion-sidebar-three .af-body input[type="submit"].listfusion-submit-btn:hover {
...
<div id="listfusion-sidebar-three" class="af-form">
  <div class="af-header">
    <div style="background-color:rgba(51, 34, 28, 0.3);padding-bottom: 50px;padding-top: 50px;padding-right:10px;padding-left:10px;">
      <div class="bodyText">
        <p> 
			<span style="font-size:<?php echo ($item_display_options['field_header_size']?$item_display_options['field_header_size']:'20'); ?>px;font-family:Capriola;font-weight:bold;text-shadow: 0px 0px 1px #524C4C;line-height:30px;"> 
  ...
  <div align="center" class="af-body af-standards">
    ...
    <div class="af-element privacyPolicy" style="text-align:center;width:100%; overflow:hidden; padding:0px; margin:0px;">
	  <?php if($item_display['security_note'] != '') { ?><p style="margin-bottom:0px;font-size: 11px; margin-top:5px;"><?php echo $item_display['security_note']; ?></p><?php } ?>
