...
#listfusion-sidebar-one .af-body input[type="submit"].listfusion-submit-btn {
...
#listfusion-sidebar-one .af-body input[type="submit"].listfusion-submit-btn:hover {
...
<div id="listfusion-sidebar-one" class="af-form">
  <div class="af-header">
    <div class="bodyText">
      <p align="center"> 
	  <span style="font-size:<?php echo ($item_display_options['field_header_size']?$item_display_options['field_header_size']:'20'); ?>px;font-weight:400;font-family:Gudea;line-height:26px;"><?php echo $item_display['title']; ?></span> 
	  </p>
    </div>
  </div>
