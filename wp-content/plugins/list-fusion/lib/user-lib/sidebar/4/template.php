...
#listfusion-sidebar-four .af-body input[type="submit"].listfusion-submit-btn {
...
#listfusion-sidebar-four .af-body input[type="submit"].listfusion-submit-btn:hover {
...
<div id="listfusion-sidebar-four" class="af-form">
  <div class="af-header">
     <?php echo $item_display['video_code']; ?>
  </div>
