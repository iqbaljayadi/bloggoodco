...
<div class="wrapper-three">
  <div class="container">
    <div class="wrapper-three-inner">
      <div class="col-lg-12 clearfix margin-top" style="margin-bottom:30px;">
        <h2 style="color: #EC0000;font-weight: bold;margin-top: 10px;font-size:<?php echo ($field_header_size?$field_header_size:'50'); ?>px;text-align: center;padding: 8px 0px;line-height: 50px;color: #444;font-family: Passion One;text-transform:capitalize;text-align:center;border-bottom: 1px dashed #CCC;color:#<?php echo $option_value['text_bold_msg_color']; ?>;"><?php echo $row['title']; ?></h2>
      </div>
