    ...
    <div class="row">
      <div class="col-md-8 col-sm-8">
        <div class="row content-page">
          <div class="col-md-12 title clearfix" style="border-bottom: 1px solid #CCC;">
            <h1 class="top-title margin-top" style="font-family:Open Sans; font-size:22px;color:#<?php echo $option_value['text_main_msg_color']; ?>;"><?php echo $row['msg']; ?></h1>
            <h2 class="bold main-title" style="color: #EC0000;font-weight: bold;margin-top: 10px;font-size:<?php echo ($field_header_size?$field_header_size:'50'); ?>px;text-align: center;padding: 8px 0px;line-height: 50px;color: #444;font-family: Passion One;text-transform:capitalize;color:#<?php echo $option_value['text_bold_msg_color']; ?>;"><?php echo $row['title']; ?></h2>
          </div>
      ...
      <div class="col-md-4 col-sm-4">
        <aside class="sidebar row">
          <h4 class="margin-bottom margin-top-half" style="color:#<?php echo $option_value['text_msg_color']; ?>;"><?php echo $row['optin_msg']; ?></h4>
          ...
          <div align="center" class="margin-top-half clearfix"> 
