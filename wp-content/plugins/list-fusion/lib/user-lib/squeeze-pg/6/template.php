      ...
      <div class="row">
        <article class="col-md-7">
          ...
          <div class="row margin-top">
            <div class="col-md-12"><?php echo $row['video_code']; ?></div>
          </div>
          <div class="row margin-top-half">
            <div class="col-md-12">
              <p style="color:#<?php echo $option_value['text_main_msg_color']; ?>;"><?php echo $row['msg']; ?></p>
        ...
        <div class="col-md-5 float-right">
          <aside class="sidebar-s6 center">
            <div class="red-arrow"><img src="<?php echo LIST_FUSION_LIBPATH.'user-lib/squeeze-pg/'; ?>images/red-arrow.png"> </div>
            <h3 class="margin-top" style="color:#<?php echo $option_value['text_msg_color']; ?>;"><?php echo $row['optin_msg']; ?></h3>
            ...
            <div class="condition-wrap-six">
			  ...
			  <span style="color:#999; font-size:14px;color:#<?php echo $option_value['text_security_color']; ?>;"><?php echo $row['security_note']; ?></span> </p>
            </div>
          </aside>
        </div>
      </div>
