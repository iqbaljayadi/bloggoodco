    ...
    <div class="wrapper-eight-inner">
      <div class="row">
        <div class="col-md-12">
          ...
          <h4 style="color:#<?php echo $option_value['text_main_msg_color']; ?>;"><?php echo $row['msg']; ?></h4>
        </div>
      </div>
      <div class="row margin-top">
        ...
        <div class="col-md-5">
          <aside class="sidebar-s6 center" style="padding-top:0px;">
            <div align="center" class="clearfix"> <img src="<?php echo LIST_FUSION_LIBPATH.'user-lib/squeeze-pg/'; ?>images/arrow.gif" class="img-responsive" alt=""> 
			</div>
            <div>
              <?php 
            ...
            <div class="condition-wrap-eight">
              <p> 
