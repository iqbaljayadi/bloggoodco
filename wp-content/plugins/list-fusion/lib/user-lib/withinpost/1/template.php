...
if( $template_submit_text_size != '' ) { $optin_form .= '#listfusion-withinpost-one .af-body input[type="submit"] {font-size: '.$template_submit_text_size.'px!important;}'; }
$optin_form .= '#listfusion-withinpost-one .af-body input[type="submit"].listfusion-submit-btn {
...
#listfusion-withinpost-one .af-body input[type="submit"].listfusion-submit-btn:hover {
...
$optin_form .= '<div id="listfusion-withinpost-one" class="af-form">
  <div class="af-header">
    <div class="bodyText">
  ...
  <div align="center" class="af-body af-standards">
    <div class="bodyText" style="padding-bottom:10px">
      <p align="left" style="padding-left:5%; padding-right:5%;"> <span style="font-size:16px;font-weight:400;font-family:Open sans;color:#222222;">'.$item_display['msg'].'</span> </p>
    </div>';
...
$optin_form .= '<div class="af-element privacyPolicy" style="text-align:center;padding-top: 5px;">
