...
if( $template_submit_text_size != '' ) { $optin_form .= '#listfusion-withinpost-four .af-body input[type="submit"] {font-size: '.$template_submit_text_size.'px!important;}'; }
$optin_form .= '#listfusion-withinpost-four .af-body input[type="submit"].listfusion-submit-btn {
...
#listfusion-withinpost-four .af-body input[type="submit"].listfusion-submit-btn:hover {
...
$optin_form .= '
<div id="listfusion-withinpost-four" class="af-form">
  <div class="af-header">
    '.$item_display['video_code'].'
  </div>
  <div align="center" class="af-body af-standards" style="padding-bottom:0px;">';
