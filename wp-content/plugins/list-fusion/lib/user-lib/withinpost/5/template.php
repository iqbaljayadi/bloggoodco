...
if( $template_submit_text_size != '' ) { $optin_form .= '#listfusion-withinpost-five .af-body input[type="submit"] {font-size: '.$template_submit_text_size.'px!important;}'; }
if( $template_background != '' ) { $optin_form .= '#listfusion-withinpost-five .af-img{ background-image: url("'.$template_background.'"); }'; }

$optin_form .= '#listfusion-withinpost-five .af-body input[type="submit"].listfusion-submit-btn {
...
#listfusion-withinpost-five .af-body input[type="submit"].listfusion-submit-btn:hover {
...
$optin_form .= '
<div id="listfusion-withinpost-five" class="af-form">
  <div class="af-header">
    <div class="bodyText" style="padding:0px 5%;">
      <p> <span style="font-size:'.($template_title_text_size?$template_title_text_size:'20').'px; font-weight:400; font-family:Gudea;line-height: 30px;">'.$item_display['title'].'</span> </p>
    </div>
  </div>
  <div class="af-img">
    <div class="bodyText" style="padding:0px 5%;">
      <p> <span style="font-size: 36px; font-weight:bold; font-family:Lilita One; color:#FFFFFF; text-shadow:0px 0px 1px #585757;">'.$item_display['msg'].'</span> </p>
    </div>
  </div>
