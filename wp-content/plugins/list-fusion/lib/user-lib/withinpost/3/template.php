...
if( $template_submit_text_size != '' ) { $optin_form .= '#listfusion-withinpost-three .af-body input[type="submit"] {font-size: '.$template_submit_text_size.'px!important;}'; }
if( $template_background != '' ) { $optin_form .= '#listfusion-withinpost-three .af-header { background-image: url("'.$template_background.'"); }'; }
$optin_form .= '#listfusion-withinpost-three .af-body input[type="submit"].listfusion-submit-btn {
...
#listfusion-withinpost-three .af-body input[type="submit"].listfusion-submit-btn:hover {
...
$optin_form .= '
<div id="listfusion-withinpost-three" class="af-form">
  <div class="af-header">
    <div style="background-color:rgba(51, 34, 28, 0.3);padding-bottom:40px;padding-top:40px;padding-right:5%;padding-left:5%;">
      <div class="bodyText">
        <p> <span style="font-size:'.($template_title_text_size?$template_title_text_size:'30').'px;font-family:Kaushan Script;font-weight:bold;text-shadow:0px 0px 1px #524C4C;line-height: 42px;">'.$item_display['title'].'</span> </p>
      </div>
    </div>
  </div>
